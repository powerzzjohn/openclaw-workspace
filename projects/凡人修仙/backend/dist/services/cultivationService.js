...
exports.resetDailyCultivation = exports.getCultivationStatus = exports.getCultivationHistory = exports.endCultivation = exports.startCultivation = void 0;
const client_1 = require("@prisma/client");
const tianshiService_1 = require("./tianshiService");
 ...
 */
const startCultivation = async (userId, city) => {
    // 检查是否已经在修炼中
    ...
    // 获取天时数据
    const tianShi = await (0, tianshiService_1.getTianShiData)({ city });
    // 更新修炼状态
    const now = new Date();
...
exports.startCultivation = startCultivation;
/**
 * 结束修炼
 * @param userId 用户ID
 */
const endCultivation = async (userId) => {
    // 获取修炼状态
    ...
    // 获取天时数据
    const tianShi = await (0, tianshiService_1.getTianShiData)();
    // 计算加成
    let bonusApplied = tianShi.totalBonus;
    let tianShiDetails = [];
    if (bazi) {
        const cultivationBonus = (0, tianshiService_1.getCultivationBonus)(bazi.primaryElement, tianShi);
...
exports.endCultivation = endCultivation;
/**
 * 获取修炼历史记录
 * @param userId 用户ID
 * @param page 页码
 * @param pageSize 每页数量
 */
const getCultivationHistory = async (userId, page = 1, pageSize = 10) => {
...
exports.getCultivationHistory = getCultivationHistory;
/**
 * 获取当前修炼状态
 * @param userId 用户ID
 */
const getCultivationStatus = async (userId) => {
...
exports.getCultivationStatus = getCultivationStatus;
/**
 * 重置每日修炼数据
 * 应该在每天凌晨调用
 * @param userId 用户ID
 */
const resetDailyCultivation = async (userId) => {
    const cultivation = await prisma.cultivation.findUnique({
        where: { userId }
    });
    if (!cultivation)
...
exports.resetDailyCultivation = resetDailyCultivation;
exports.default = {
    startCultivation: exports.startCultivation,
    endCultivation: exports.endCultivation,
    getCultivationHistory: exports.getCultivationHistory,
    getCultivationStatus: exports.getCultivationStatus,
    resetDailyCultivation: exports.resetDailyCultivation
};
