...
exports.getCultivationBonus = exports.getTianShiData = exports.getMoonPhase = exports.getZiWuLiuZhu = exports.getWuYunLiuQi = exports.getWeatherData = void 0;
 ...
 * @param date 日期
 */
const getWuYunLiuQi = (date = new Date()) => {
...
exports.getWuYunLiuQi = getWuYunLiuQi;
/**
 * 计算运气加成系数
 */
const calculateYunQiBonus = (yunElement, siTianElement) => {
    // 同气相求，加成更高
    const elementMatch = {
        '木': ['木'],
        '火': ['火'],
 ...
 * @param date 日期
 */
const getZiWuLiuZhu = (date = new Date()) => {
...
exports.getZiWuLiuZhu = getZiWuLiuZhu;
// ============================================
// 月相计算
// ============================================
/**
 ...
 * @param options 选项
 */
const getTianShiData = async (options = {}) => {
    const date = options.date || new Date();
    // 并行获取各项数据
    const [weather, wuYunLiuQi, ziWuLiuZhu, moonPhase] = await Promise.all([
        (0, exports.getWeatherData)(options.city, options.lat, options.lon),
        Promise.resolve((0, exports.getWuYunLiuQi)(date)),
        Promise.resolve((0, exports.getZiWuLiuZhu)(date)),
        Promise.resolve((0, exports.getMoonPhase)(date))
    ]);
    // 计算总加成
    const totalBonus = parseFloat((wuYunLiuQi.yunQiBonus * ziWuLiuZhu.bonus * moonPhase.bonus).toFixed(2));
    return {
...
exports.getTianShiData = getTianShiData;
/**
 * 获取修炼加成系数（考虑灵根和天时）
 * @param userElement 用户主灵根五行
 * @param tianShi 天时数据
 */
const getCultivationBonus = (userElement, tianShi) => {
    const details = [];
    // 基础加成
...
exports.getCultivationBonus = getCultivationBonus;
exports.default = {
    getWeatherData: exports.getWeatherData,
    getWuYunLiuQi: exports.getWuYunLiuQi,
    getZiWuLiuZhu: exports.getZiWuLiuZhu,
    getMoonPhase: exports.getMoonPhase,
    getTianShiData: exports.getTianShiData,
    getCultivationBonus: exports.getCultivationBonus
};
//# sourceMappingURL=tianshiService.js.map